...
function updateLoginUI() {
    ...
    if (user) {
        ...
        loginArea.innerHTML = `
        <input type="text" name="email" id="email" autofill="tmmd-email" placeholder="Email" />
        <input type="password" name="password" id="password" autofill="off" placeholder="Password" />
